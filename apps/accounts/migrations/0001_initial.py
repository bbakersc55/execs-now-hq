    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('purpose', models.CharField(choices=[('signin', 'Sign in'), ('pin_reset', 'Note PIN reset')], default='signin', max_length=16)),
                ('expires_at', models.DateTimeField()),
                ('used_at', models.DateTimeField(blank=True, null=True)),
                ('requested_ip', models.GenericIPAddressField(blank=True, null=True)),
                ('redirect_to', models.CharField(blank=True, default='', max_length=500)),
            ],
            options={
